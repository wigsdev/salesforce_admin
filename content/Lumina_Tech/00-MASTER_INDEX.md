...
1.  **📜 ¿Qué vamos a hacer?**
    *   [SPRINT 1 (Requerimientos)](SPRINT%201.md): Lee esto primero. Define el problema de la Rectora Vance.
    *   [Identidad Visual](Identidad_Colores.md): Conoce los colores (`#005A9C`) y el logo.

2.  **🧠 ¿Cómo trabajamos?**
    *   [Guía Metodológica](Gestor_de_Versiones/00-GUIA_METODOLOGICA.md): Las reglas del juego (Semanas, Entregables).
    *   [Integración Trello](Gestor_de_Versiones/00-INTEGRACION_TRELLO.md): Cómo mover las tarjetas.
...
2.  **📐 Diseño de Solución**
    ...
    *   [Investigaciones Técnicas](Gestor_de_Versiones/06-Investigaciones.md): Por qué elegimos Junction Object y Regex.
