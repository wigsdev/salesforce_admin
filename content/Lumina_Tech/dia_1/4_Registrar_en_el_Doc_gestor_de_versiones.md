...
⚠️ **Bloqueo Detectado**: No podemos probar la "Inscripción" hasta que no tengamos datos de muestra. Se solicita al DevOps Specialist preparar un CSV con 5 alumnos y 3 materias para el Día 2.

---
**Firma**: Release Manager.
