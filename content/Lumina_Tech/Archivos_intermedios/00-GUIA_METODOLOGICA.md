...
2.  **Output**: [02-Salesforce_Consultant.md](../Gestor_de_Versiones/02-Salesforce_Consultant.md).
...
2.  **Log**: Registrar todo en [03-Salesforce_Admin.md](../Gestor_de_Versiones/03-Salesforce_Admin.md) (Bitácora Diaria).
...
1.  **La Evidencia es Rey**:
    *   Si el QA probó un fallo, debe haber log en el archivo [04-Tester_QA.md](../Gestor_de_Versiones/04-Tester_QA.md).
    *   Si el Admin creó una App, debe estar listada en el archivo [03-Salesforce_Admin.md](../Gestor_de_Versiones/03-Salesforce_Admin.md).

2.  **Traza la Historia (Traceability)**:
    *   El Requisito ([01](../Gestor_de_Versiones/01-Business_Analyst.md)) -> Se diseñó ([02](../Gestor_de_Versiones/02-Salesforce_Consultant.md)) -> Se construyó ([03](../Gestor_de_Versiones/03-Salesforce_Admin.md)) -> Se probó ([04](../Gestor_de_Versiones/04-Tester_QA.md)).
...
3.  **Higiene del Root**:
    ...
    *   Si es oficial, va a [Gestor_de_Versiones](../Gestor_de_Versiones/).

---
**Siguiente Paso**: Revisa el [00-MASTER_INDEX.md](00-MASTER_INDEX.md) en Archivos Intermedios para navegar esta estructura. 🚀
