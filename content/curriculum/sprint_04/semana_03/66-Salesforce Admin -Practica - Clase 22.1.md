...
No empieces mostrando campos o flujos. Sigue este orden:
El Problema (Contexto): "Antes, los agentes perdían 20 minutos cargando datos manualmente..."
La Solución (Valor): "Implementamos un Screen Flow optimizado que automatiza la validación..."
El Resultado (Impacto): "...reduciendo el tiempo de carga a solo 2 minutos y mejorando la calidad de la data."
vamos a ver la segunda parte de modelado de datos… 



Habla de "Capacidades", no de "Componentes"


En Salesforce, todo gira en torno al usuario. No digas "creé un objeto", di:
"Como Gerente de Ventas, vas a ver en tiempo real el pipeline gracias a este nuevo Dashboard."
Esto ayuda a los stakeholders a visualizar el uso real de la plataforma.
Evita el lenguaje excesivamente técnico a menos que sea una demo puramente para desarrolladores.
Mal: "Creamos un Trigger y tres Record-Triggered Flows."
Bien: "Automatizamos el ciclo de vida del Caso para que el cliente reciba una notificación inmediata al cierre."
vamos a ver la segunda parte de modelado de datos… 



La Regla de "Hacer, no decir"


Mientras hablas, la pantalla debe mostrar la acción. El discurso debe sincronizarse con el clic:
"Observen cómo, al cambiar la etapa a 'Cerrada Ganada', el sistema genera automáticamente el contrato en PDF."
Tip Pro: Si la automatización tarda unos segundos, usa ese espacio para explicar el beneficio de negocio.
Palabra Técnica
Cámbiala por Valor de Negocio
Custom Object
"Módulo especializado para la gestión de..."
Validation Rule
"Aseguramiento de la integridad de los datos."
Layout / Lightning Page
"Experiencia de usuario intuitiva y productiva."
Deployment / Push
"Entrega de valor inmediata al entorno de..."
vamos a ver la segunda parte de modelado de datos… 
...
Termina siempre con una pregunta de feedback directa, no una genérica:
Genérica: "¿Alguna duda?"
Efectiva: "Desde la perspectiva de la operación, ¿ven algún paso en este flujo que podamos simplificar aún más?"
Nota: Recuerda que en una Demo, el silencio es tu enemigo. Si hay una pantalla de carga, ten preparado un dato curioso sobre la configuración o un "insight" que descubrieron durante el Sprint.
vamos a ver la segunda parte de modelado de datos… 



EJERCICIO
Subir un audio de 40 segundos que explique detalladamente:

¿Por qué quiero ser un Salesforce Administrator?

Utilizando las herramientas de Elevator Pitch
