...
class Task(Base):
    ...
    category = Column(String(50), nullable=False, index=True)  # Clase, Superbadge, Practica
    ...
    progress = relationship("UserProgress", back_populates="task", cascade="all, delete-orphan")
