...
input_file = r"c:\Users\WIGUSA\Documents\GitHub\admin_salesforce\content\Lumina_Tech\Archivos_intermedios\CSV\Historico_Alumnos_2024.csv"
output_file = r"c:\Users\WIGUSA\Documents\GitHub\admin_salesforce\content\Lumina_Tech\Archivos_intermedios\CSV\Historico_Alumnos_2024_limpio.csv"
    ...
    with open(input_file, mode="r", encoding="utf-8") as infile:
        ...
        with open(output_file, mode="w", encoding="utf-8", newline="") as outfile:
            ...
            for row in reader:
                ...
                writer.writerow(row)
    print("SUCCESS: Archivo limpio generado correctamente.")
