...
def downgrade() -> None:
    # Reverse operations
    op.add_column('lumina_deliverables', sa.Column('weight', sa.INTEGER(), autoincrement=False, nullable=False, server_default='0'))
    op.add_column('lumina_deliverables', sa.Column('role', sa.VARCHAR(), autoincrement=False, nullable=False, server_default='general'))
